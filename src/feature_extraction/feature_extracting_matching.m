function Corr = feature_extracting_matching(I1, I2, do_plot)
    ...
    Corr = ransac_algorithm(correspondences(:,1:400), 'epsilon', 0.75, 'tolerance', 0.08);

    % Visualize robust correspondences
    if do_plot
        visualize_correspondences(I1,I2,Corr,300);
    end
end
