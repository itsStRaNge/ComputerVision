function features = feature_extracting_matching(I1, I2, K, do_plot)
    % Get the Key Points
    Options.upright=true;
    Options.tresh=0.0005;
    ...
    features.descriptors1 = D1;
    features.descriptors1 = D2;
    ...
    if do_plot
        ...
        visualize_matches(I1,I2,matches,300);
    end
    ...
    if do_plot
        ...
        visualize_matches(I1,I2,robust_matches,300);
    end
